...
class SnailRacer {
    ...
    update() {
        this.element.style.marginLeft = `${this.xpos}px`
    }

    render() {
        const element = document.createElement("div");
        element.className = "snail-racer";
        element.innerHTML = `
            <svg class="snail" viewBox="0 0 260 200" xmlns="http://www.w3.org/2000/svg">
                <path class="snail__body" d="${dBody}"/>
                <path class="snail__shell" d="${dShell}"/>
            </svg>
            <div class="snail-racer__name">${this.name}</div>
        `;
        element.querySelector(".snail__shell").style.fill = this.color;
